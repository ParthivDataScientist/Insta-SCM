...
class Settings(BaseSettings):
    ...
    DHL_SHIPPER_ADDRESS1: str = "1001, 10th Floor, Kohinoor Continental"
    DHL_SHIPPER_ADDRESS2: str = "J.B Nagar, Andheri-Kurla Road"
    ...
    DHL_SHIPPER_STATE_CODE: str = ""
    DHL_SHIPPER_STATE_NAME: str = ""
