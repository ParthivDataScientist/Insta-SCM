                ...
                <tbody>
                    {projects.map(p => (
                        ...
                        >
                            ...
                            <td 
                                onClick={(e) => { 
                                    if (p.manager_id && p.project_manager) {
                                        e.stopPropagation(); 
                                        setViewingManager({ id: p.manager_id, name: p.project_manager }); 
                                    }
                                }}
                            ...
                            <DateCell project={p} field="dispatch_date" editingCell={editingCell} setEditingCell={setEditingCell} updateProjectFull={updateProjectFull} />
